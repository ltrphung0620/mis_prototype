...
class DashboardBusinessStatus(StrEnum):
    ...
    NEGOTIATION_AWAITING_FINAL_CONFIRMATION = "NEGOTIATION_AWAITING_FINAL_CONFIRMATION"
    ACCEPTED = "ACCEPTED"
...
class DashboardInteractionType(StrEnum):
    ...
    NEGOTIATION_TERMS_SENT_CONFIRMATION = "NEGOTIATION_TERMS_SENT_CONFIRMATION"
    NEGOTIATION_OUTCOME_INPUT = "NEGOTIATION_OUTCOME_INPUT"
