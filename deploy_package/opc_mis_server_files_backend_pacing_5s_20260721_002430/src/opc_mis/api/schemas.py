...
class DemoPauseRequest(BaseModel):
    """Manual, non-governance pause requested for live demonstrations."""

    model_config = ConfigDict(frozen=True, extra="forbid")

    reason: str = Field(default="LIVE_DEMO_PAUSE", min_length=1, max_length=160)
