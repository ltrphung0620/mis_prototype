const TRANSLATIONS: Record<string, string> = {
  ...
  "Part of the contract value lacks explicit order coverage": "Tổng giá trị các đơn hàng bên trong hợp đồng chưa cover hết toàn bộ giá trị hợp đồng",
  "The verified uncovered-contract-value fact must not be treated as explained revenue, cost, or delivery scope.": "Tổng giá trị các đơn hàng đã liên kết đang thấp hơn giá trị hợp đồng, nên phần chênh lệch chưa có cơ sở để coi là doanh thu, chi phí hoặc phạm vi bàn giao đã được giải thích.",
  "Resolve the uncovered contract value": "Làm rõ phần giá trị hợp đồng chưa được các đơn hàng liên kết cover",
  "Provide explicit order, phase, amendment, or scope relationships and run Finance and Operations again.": "Bổ sung đơn hàng, giai đoạn triển khai, phụ lục hoặc quan hệ phạm vi để tổng giá trị đơn hàng liên kết khớp với hợp đồng, sau đó chạy lại đánh giá Tài chính và Vận hành.",
  ...
  "Final Risk is limited by evidence": "Final Risk chưa có closing cash cấp hợp đồng nên chỉ dùng được tín hiệu áp lực dòng tiền đang có",
  "No exact closing_cash fact exists; projected_closing_cash is not silently aliased.": "Chưa có closing cash riêng cho hợp đồng; hệ thống không tự lấy projected_closing_cash để thay thế. Founder cần xem trực tiếp tháng có worst gap và các tháng dòng tiền âm trước khi chấp nhận.",
  "Resolve the Final Risk evidence limitation": "Bổ sung closing cash cấp hợp đồng hoặc bằng chứng nguồn cho các tháng áp lực dòng tiền",
  ...
  "20-province rollout may exceed current contractor capacity": "Việc triển khai tại 20 tỉnh có thể vượt quá năng lực hiện tại của nhà thầu. OpenAI có thể đề xuất cho Founder yêu cầu khách hàng đàm phán thêm giờ làm, nhân sự.",
  "Operations has planned/past-due evidence but no exact delivery_delay_days fact.": "Hệ thống thấy có dấu hiệu kế hoạch giao hàng/quá hạn, nhưng chưa có con số chính xác về số ngày chậm giao thực tế. Vì vậy rủi ro vận hành được giữ ở trạng thái cần xác minh, chưa được lượng hóa thành mức trễ cụ thể.",
